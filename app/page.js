...
export default function Home() {
  return (
    <>
      <Head>
        <meta property='og:url' content='https://www.aigaloutop100.com/' key='ogurl' />
      </Head>
        ...
        <div className='flex flex-col gap-32 lg:gap-48 mx-auto w-full max-w-3xl items-center pt-[30vh] pb-[10vh] md:pb-[10vh] lg:pb-[20vh] h-md:pt-[34vh] h-lg:pt-[30vh] transition-all duration-500 z-30'>
          ...
          <div className='flex flex-col gap-6 w-full'>
            ...
            <p className='font-[350] text-lg leading-7 text-white'>
              ...
              Agencies, freelancers, and in-house teams are celebrated for their efforts in a range of design
              disciplines including advertising, branding, packaging, environmental design, interactive design, service
              design, and more. The awards culminate in the top 100 works – showcasing the Best of Category winners and
              a single work that is Best of Show.
            </p>
          </div>
          <div className='flex flex-col gap-6 w-full'>
            ...
            <div className='flex w-full'>
              <Accordion type='single' collapsible className='w-full flex flex-col gap-2 '>
                <AccordionItem value='item-1'>
                  ...
                  <AccordionContent>
                    Professional and student designers from all over the region are eligible to submit their work.
                    First, an AIGA account is required.{' '}
                    ...
                    member. Then log out to reset your cart. To opt-out of the join process once you&apos;ve created
                    your account, close the tab and return to the competition page to login and continue with the
                  ...
                  <AccordionContent>
                    <ul className='list-disc pl-4 flex flex-col gap-3'>
                      ...
                      <li>
                        ...
                        <br />
                        Includes photojournalism, editorial, portrait, fashion, street, sports, wildlife, aerial,
                        product, composite, commercial, etc.
                      </li>
                      <li>
                        <strong>Print:</strong>
                        <br />
                        Posters and flyers, stationary and business cards, merchandising, direct mailing campaigns,
                        print advertisements, currency and coin design, stamps and more.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        <br />
                        Includes any type of deliverable from other categories that showcases the use of handlettering
                        or focus on typographic treatment. Also includes the creation or refinement of a typeface.
                      </li>
                      <li>
                ...
                <AccordionItem value='item-5'>
                  <AccordionTrigger>
                    I think I&apos;m a member, but I&apos;m getting the nonmember rate?
                  </AccordionTrigger>
                  <AccordionContent>
                    ...
                    <a
                      href='https://my.aiga.org/individual-directory'
                      className='underline font-semibold text-[#ffa6f2]'
                    >
                      Member Directory
                    </a>{' '}
                    to confirm if a colleague has an active membership (Note: names of members in good standing will
                    only appear if they have selected the directory option). Please contact{' '}
                ...
                <AccordionItem value='item-6'>
                  ...
                  <AccordionContent>
                    The competition system looks at your member type when you login to determine the correct fees. If
                    you decide to join or renew in mid-cart, you must log out to reset the fees. See below for more
                    information.
                  </AccordionContent>
                </AccordionItem>
