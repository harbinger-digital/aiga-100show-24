...
export default function Footer() {
  return (
    <footer class='mx-auto w-full pb-8 max-w-3xl'>
      <div class='w-full'>
        <div class='md:flex'>
        ...
        <div class='sm:flex sm:items-center sm:justify-between'>
          <span class='text-sm text-white sm:text-center dark:text-gray-400'>
            © 2024{' '}
            <a href='https://louisville.aiga.org/' class='hover:underline'>
              AIGA LOU{' '}
            </a>
            All Rights Reserved.
          </span>
          <div class='flex mt-4 sm:justify-center sm:mt-0'>
            <a href='https://www.facebook.com/aigalou/' class='text-white hover:text-gray-90'>
              <svg
                class='w-4 h-4'
                aria-hidden='true'
