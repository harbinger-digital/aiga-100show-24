    ...
    <>
      ...
      <div className='fixed bottom-0 left-0 transform -translate-x-1/2 translate-y-1/2 mix-blend-soft-light opacity-40 -z-30'>
        <div className='relative flex flex-col items-center justify-center left-1/2 transform -translate-x-1/2 -translate-y-1/8 w-[500px] h-[500px]'>
          <motion.div
            className='absolute w-[225px] h-[225px] lg:w-[300px] lg:h-[300px] 2xl:w-[400px] 2xl:h-[400px] transition-all duration-500'
            animate={{ rotate: 180 }}
          ...
          <motion.div
            className='absolute w-[400px] h-[400px] lg:w-[500px] lg:h-[500px] 2xl:w-[700px] 2xl:h-[700px] transition-all duration-500'
            animate={{ rotate: -180 }}
          ...
          <motion.div
            className='absolute w-[550px] h-[550px] lg:w-[700px] lg:h-[700px] 2xl:w-[1000px] 2xl:h-[1000px] transition-all duration-500'
            animate={{ rotate: 180 }}
          ...
          <motion.div
            className='absolute w-[700px] h-[700px] lg:w-[900px] lg:h-[900px] 2xl:w-[1300px] 2xl:h-[1300px] transition-all duration-500'
            animate={{ rotate: -180 }}
